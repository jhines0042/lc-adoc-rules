...
// Corrected typo in next line MCW 190329
ifdef::Review[##]
...
// Next paragraph ends with qa colon, indicating a stem. Changed the subsequent three paragraphs to bullets.
ifdef::Review[##]
...
include::glossary.adoc[tags=Disarm;Fear;Repel;Shove;Sicken;Slow;Smash;Stun;Sunder;Trip]
