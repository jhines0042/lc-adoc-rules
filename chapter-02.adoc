= *Chapter 2: Safety and Community Standards*
:imagesdir: images
:linkcss:
...
include::glossary.adoc[tags=IG;OOG;PC;NPC;Player;Marshal;Staff;Director;Hold;Scene;Narration]
...
For full details on how these hand signs are used check the Full Rulebook
...
Reminder that the full set of safety rules and some other important rules are available in the full rulebook.  To save space we are leaving out the "following the rules" portion from this Quickstart handbook.
